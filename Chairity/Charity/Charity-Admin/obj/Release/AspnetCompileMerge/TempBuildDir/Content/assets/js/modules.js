...
function chartJSInit() {
	...
	if ($('#_chartJS_min').length > 0) {
		...
		if($("#chart_line_tension1").length) {
			let chartTSN = document.querySelector("#chart_line_tension1").getContext("2d"),
